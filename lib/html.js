...
<div id="app">
  ...
  <div v-else class="app">
    ...
    <div class="main">
      ...
      <!-- Post Editor -->
      <div v-if="route==='/posts/new'||route.startsWith('/posts/edit')">
        <div class="toolbar">
        ...
        <div class="editor-layout">
          <div class="editor-pane">
            <label class="text-sm text-muted mb-8" style="display:block">Markdown 内容</label>
            <textarea v-model="editor.content" @input="debouncePreview" placeholder="在此编写 Markdown 内容..."></textarea>
          </div>
...
const app = createApp({
  setup(){
    ...
    const themeConfigData = ref({info:{},defaults:{},colors:{},home_banner:{image:{}},articles:{style:{},toc:{}},footer:{}});
    ...
    function handleHash(){
      ...
      else if(h==='/posts/new') resetEditor();
    ...
    async function loadConfig(){
      ...
      try{
        ...
        if(configType.value==='site'){
          ...
          themeConfigData.value=data.parsed||{info:{},defaults:{},colors:{},home_banner:{image:{}},articles:{style:{},toc:{}},footer:{}};
        }
      }catch(e){toast(e.message,'error');}
