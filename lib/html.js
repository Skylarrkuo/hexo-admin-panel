        ...
        <div class="editor-layout">
          <div class="editor-pane">
            <div class="editor-toolbar">
              ...
              <span class="toolbar-divider"></span>
              <button class="toolbar-btn" @click="insertFormat('\\x60','\\x60')" title="行内代码">\` Code</button>
...
const app = createApp({
  setup(){
    ...
    return {
      ...
      editorDragOver,editorUploading,editorTextarea,insertFormat,insertAtCursor,uploadImageFile,handleEditorDrop,handleEditorPaste,insertImage,
