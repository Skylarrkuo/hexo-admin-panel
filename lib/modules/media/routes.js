...
function mediaRoutes(context) {
  ...
  return [
    { method: 'GET', path: '/media', handler({ res, query }) { validateIntegerQuery(query.page,'page',{min:1});validateIntegerQuery(query.per_page,'per_page',{min:1,max:100});success(res,media.list(query)); } },
    {
